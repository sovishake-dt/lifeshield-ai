...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  // IMPORTANT:
  // Only the API key entered by the user counts as "Gemini Connected".
  // We do NOT use health.hasGeminiKey here because the Render backend
  // may have its own environment key configured.
  const isKeyActive = hasUserKey && !forceDemo;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            ...
            {/* Backend Status */}
            <div
              className={`hidden lg:flex items-center space-x-1.5 px-2.5 py-1 rounded-full border text-[11px] ${
                backendOnline
              ...
              title={
                backendOnline
                  ? 'LifeShield backend is online'
                  : 'LifeShield backend is unavailable'
              }
            >
              <span
            ...
            <button
              ...
              title={
                forceDemo
                  ? 'Switch to Live Gemini AI mode'
                  : 'Switch to Judge Demo mode'
              }
